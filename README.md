...
pandas development team. (2025). pandas documentation: DataFrame.to_parquet (Version current). https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.to_parquet.html

Pyreadstat developers. (2025). pyreadstat documentation: read_dta. https://ofajardo.github.io/pyreadstat_documentation/
...
Apache Software Foundation. (2025). Apache Parquet format: Specification & docs. https://parquet.apache.org/docs
